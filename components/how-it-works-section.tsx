...
const steps = [
  ...
  },
  {
    ...
    description:
      "Our AI engine scans your resume against hundreds of data points and hiring patterns.",
  },
  {
    icon: ClipboardList,
    step: "03",
    ...
    description:
      "Receive a detailed breakdown with scores, suggestions, and a prioritized action plan.",
  },
]

export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="bg-secondary/50 px-6 py-20 md:py-28">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          {steps.map((item, index) => (
            <div key={item.step} className="relative flex flex-col items-center text-center">
              ...
              <div className="relative z-10 flex h-20 w-20 items-center justify-center rounded-2xl border-2 border-primary/20 bg-card text-primary shadow-sm">
